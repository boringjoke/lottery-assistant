        ...
        <span class="login-note__icon" aria-hidden="true">
          <svg class="login-note__svg" viewBox="0 0 1024 1024">
            <path
              ...
              fill="#F9DB91"
            />
            <path d="M394.92 777.88v54.37A115.13 115.13 0 0 0 509.67 947h4.66a115.13 115.13 0 0 0 114.75-114.75v-54.37H394.92z" fill="#EF6A6A" />
            <path d="M512.15 351.25c-40.28 0-45.1 44.62-40.36 99.21 5.13 58.92 22.88 97.37 40.36 99.2 12.69 1.34 36.65-37.75 40.35-99.2 3.3-54.7 2.6-99.21-40.35-99.21z" fill="#AEF0FF" />
